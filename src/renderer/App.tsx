...
const App = () => {
    ...
    async function loadStateAndSettings() {
      ...
      try {
        ...
        if (savedState.activeView && savedState.activeView !== activeView) {
          setActiveView(savedState.activeView as View);
        }
  ...
  useEffect(() => {
    const onOpenAddAccountModal = (e: Event) => {
      ...
      const allowed: AddAccountInitialTab[] = ['panel', 'cookie', 'creds', 'device', 'bridge'];
      setAccountsOpenAddModalTab(t && allowed.includes(t) ? t : 'bridge');
    ...
    <div className="app">
      ...
      <div className={sidebarClass} id="sidebar">
        ...
        <div className="nav">
          ...
          <NavItem view="reputation" icon="fa-user-shield" label="Reputation" active={activeView} onClick={handleViewChange} />

          <div className="nav-section-label">Operations</div>
          <NavItem view="tasks" icon="fa-tasks" label="Tasks" active={activeView} onClick={handleViewChange} />
          <NavItem view="analytics" icon="fa-chart-line" label="Analytics" active={activeView} onClick={handleViewChange} />
          <NavItem view="telegram" iconPrefix="fab" icon="fa-telegram-plane" label="Telegram" active={activeView} onClick={handleViewChange} />
          <NavItem view="audit" icon="fa-history" label="Audit Logs" active={activeView} onClick={handleViewChange} />
          ...
          <NavItem view="search" icon="fa-search" label="Account Search" active={activeView} onClick={handleViewChange} />
